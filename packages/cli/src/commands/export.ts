...
export function buildSpawnMd(record: SpawnRecord): string {
  ...
  lines.push("");
  lines.push(`This template was generated by \`${AGENTSEA_CLI} export\`. Re-spawn it with the`);
...
export function buildReadmeTemplate(): string {
  return [
    "# __NAME__",
    "",
    "Exported from a [spawn](https://github.com/Spectral-Finance/agentsea) session on `__CLOUD__`.",
    "",
    "## Quickstart",
    "",
    "```bash",
